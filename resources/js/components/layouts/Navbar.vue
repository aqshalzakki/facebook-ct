<template>
    <div class="bg-white h-12 px-4 flex items-center border-b border-gray-400 shadow-sm">
        ...
        <div class="w-1/3 flex justify-center items-center h-full">
            <router-link :to="{name: 'home'}" class="px-6 border-b-2 border-blue-500 h-full flex items-center">
            ...
            <router-link v-if="authUserStatus" :to="{name: 'users.show', params: { userId: user.data.user_id }}" class="px-6 border-b-2 border-white h-full flex items-center">
                <img src="https://cdn.pixabay.com/photo/2014/07/09/10/04/man-388104_960_720.jpg" alt="profile image for user" class="w-8 h-8 w-8 object-cover rounded-full">
            </router-link>
            <router-link :to="{name: 'home'}" class="px-6 border-b-2 border-white h-full flex items-center">
